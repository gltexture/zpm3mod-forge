...
import ru.gltexture.zpm3.engine.client.rendering.items.guns.ZPDefaultPistolRenderer;
...
public abstract class ZPRegGuns {
    public static void init(@NotNull ZPRegistry.ZPRegSupplier<Item> regSupplier) {
        ZPItems.makarov = regSupplier.register("makarov",
                () -> new ZPGunPistol(new Item.Properties().stacksTo(1))
            ...
            utils.items().setItemRenderer(e, new ZPItemRenderingProcessor(new ZPDefaultPistolRenderer()));
        }).registryObject();
    }
}
