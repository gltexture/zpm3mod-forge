...
public abstract class AbstractSmokeParticle extends TextureSheetParticle {
    ...
    protected AbstractSmokeParticle(ClientLevel level, @NotNull SpriteSet pSprites, Vector3f position, Vector3f velocity, Vector3f color, float scale, int lifeTime) {
    ...
    public void tick() {
        super.tick();
        this.setSpriteFromAge(this.pSprites);
        final float e2 = (float) Math.exp(2.0f);
