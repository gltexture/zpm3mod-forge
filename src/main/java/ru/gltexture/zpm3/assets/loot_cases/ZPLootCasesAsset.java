    ...
    public static class ZPDefaultLootTables extends ZPLootTablesRegistry {
        ...
        private static ZPLootTable loot_debris = ZPLootTable.builder("loot_debris")
                ...
                .bonusGroup("bonus", 0.03f, (g) -> g
                        ...
                        .addBreakable("minecraft:stone_axe",              2, 0.6f, 1.0f, 1.0f)
                        .addBreakable("minecraft:stone_shovel",           2, 0.6f, 1.0f, 1.0f)
                        .addBreakable("minecraft:stone_hoe",              2, 0.6f, 1.0f, 1.0f)
                        .addNonBreakable("minecraft:slime_ball",         2,   1, 1, 1.0f)
                        ...
                        .addNonBreakable("minecraft:wall_lamp_off",        4, 1, 1, 1.0f)
                        .addNonBreakable("minecraft:block_lamp_off",        4, 1, 1, 1.0f)
                )
                .build(3, 8, 1.0f, 0.8f);
        ...
        private static ZPLootTable loot_case_tier_low = ZPLootTable.builder("loot_case_tier_low")
                ...
                .commonGroup("meds", 8, g -> g
                        .addNonBreakable("zpm3:bandage", 12, 1, 1, 1.0f)
                ...
                .commonGroup("food", 10, g -> g
                        .addNonBreakable("zpm3:peaches", 2, 1, 2, 1.0f)
                        .addNonBreakable("zpm3:soda", 2, 1, 2, 1.0f)
                        .addNonBreakable("minecraft:bread", 2, 1, 3, 1.0f)
                        .addNonBreakable("minecraft:cooked_chicken", 1, 1, 1, 1.0f)
                        .addNonBreakable("zpm3:jam", 2, 1, 2, 1.0f)
                        .addNonBreakable("zpm3:bean", 2, 1, 2, 1.0f)
        ...
        private static ZPLootTable loot_case_tier_mid = ZPLootTable.builder("loot_case_tier_mid")
                ...
                .commonGroup("food", 16, g -> g
                        ...
                        .addNonBreakable("minecraft:cooked_beef", 4, 1, 2, 1.0f)
                        .addNonBreakable("minecraft:cooked_porkchop", 4, 1, 2, 1.0f)
                        .addNonBreakable("minecraft:cooked_chicken", 4, 1, 2, 1.0f)
                        .addNonBreakable("zpm3:jam", 2, 1, 2, 1.0f)
                ...
                .commonGroup("meds", 12, g -> g
                        .addNonBreakable("zpm3:bandage", 18, 1, 1, 1.0f)
        ...
        private static ZPLootTable loot_case_tier_hi = ZPLootTable.builder("loot_case_tier_hi")
                ...
                .commonGroup("meds", 26, g -> g
                        .addNonBreakable("zpm3:military_bandage", 8, 1, 2, 1.0f)
                ...
                .commonGroup("food", 26, g -> g
                        ...
                        .addNonBreakable("zpm3:bean", 3, 1, 3, 1.0f)
                        .addNonBreakable("zpm3:water", 2, 1, 3, 1.0f)
                )
                .bonusGroup("bonus", 0.35f, g -> g
                        ...
                        .addNonBreakable("minecraft:diamond", 2, 1, 2, 1.5f)
                        .addNonBreakable("minecraft:emerald", 2, 1, 3, 1.4f)
