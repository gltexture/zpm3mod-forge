...
public class ZPDefaultGunParticlesFX implements IZPGunParticlesFX {
    ...
    public static void emmitParticleSmoke(boolean isRightHand, Player player) {
        final ZPGunFXGlobalData.ClientGunRenderGlobalData gun = isRightHand ? ZPGunFXGlobalData.getRight() : ZPGunFXGlobalData.getLeft();
        ...
        gun.getCurrentMuzzleflashOffset().transform(muzzle);
        gun.getCurrentGunItemMatrix().transform(muzzle);
    ...
    public static void emmitParticleShell(boolean isRightHand, Player player) {
        ...
        float distanceToGun = gun.getCurrentGunItemMatrix().getScale(new Vector3f()).z / 1.75f;
