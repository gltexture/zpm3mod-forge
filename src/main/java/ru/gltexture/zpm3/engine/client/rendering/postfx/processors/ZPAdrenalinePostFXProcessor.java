...
public class ZPAdrenalinePostFXProcessor extends ZPPostFXProcessor{
    public ZPAdrenalinePostFXProcessor(int chainOrder) {
        super(chainOrder);
    }
    ...
    protected ZPShaderLoader.ZPShaderInstance getPostFXShader() {
        return ZPDefaultShaders.post_fx_adrenaline;
    }
