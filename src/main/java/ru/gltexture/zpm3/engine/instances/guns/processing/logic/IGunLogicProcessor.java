package ru.gltexture.zpm3.engine.instances.guns.processing.logic;
...
public interface IGunLogicProcessor {
    ...
    void onTickInventory(@NotNull ItemStack pStack, @NotNull Level pLevel, @NotNull ZPBaseGun item, @NotNull Entity pEntity, int pSlotId, boolean pIsSelected);
}
