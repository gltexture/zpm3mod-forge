...
public abstract class ZPRecipeRemoverMixin implements IZPRecipesManagerExt {
    ...
    @Override
    public Map<RecipeType<?>, Map<ResourceLocation, Recipe<?>>> zpm3forge$getRecipes() {
        return this.recipes;
    }

    public void zpm3forge$removeRecipes(@NotNull Collection<ZPRecipesController.RecipeToRemove> toRemove) {
