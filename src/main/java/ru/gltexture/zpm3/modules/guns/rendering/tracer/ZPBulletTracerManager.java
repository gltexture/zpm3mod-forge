package ru.gltexture.zpm3.modules.guns.rendering.tracer;
...
public final class ZPBulletTracerManager {
    ...
    public void renderAll(PoseStack poseStack, float partialTicks, float deltaTicks) {
        ...
        while (tracerIterator.hasNext()) {
            ...
            ZPBulletTracerManager.drawShortLine(poseStack, tracer.getTracerPath().start, tracer.getTracerPath().end, tracer.getCurrentPos(), 1.0f, 0.9f, 0.85f, 0.65f);
