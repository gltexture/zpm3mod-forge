...
public final class ZPLootNbtBoolean extends ZPLootNbtValue {
    private final boolean value;

    public ZPLootNbtBoolean(boolean value) {
        super(ZPLootNbtValue.TYPE_BOOLEAN);
        this.value = value;
    }

    @Override
    public void writeValue(@NotNull CompoundTag nbt, @NotNull String key) {
        nbt.putBoolean(key, this.value);
    }
