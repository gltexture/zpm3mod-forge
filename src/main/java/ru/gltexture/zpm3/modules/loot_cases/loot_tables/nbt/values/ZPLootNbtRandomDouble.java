...
public final class ZPLootNbtRandomDouble extends ZPLootNbtValue {
    private final double min;
    private final double max;
    private final ZPRandomization randomization;

    public ZPLootNbtRandomDouble(double min, double max, @NotNull ZPRandomization randomization) {
        super(ZPLootNbtValue.TYPE_RANDOM_DOUBLE);
        this.min = min;
        this.max = max;
    ...
    public void writeValue(@NotNull CompoundTag nbt, @NotNull String key) {
        nbt.putDouble(key, this.randomization.random(this.min, this.max));
    }
