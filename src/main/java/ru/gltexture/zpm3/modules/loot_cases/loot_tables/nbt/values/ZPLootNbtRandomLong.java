...
public final class ZPLootNbtRandomLong extends ZPLootNbtValue {
    private final long min;
    private final long max;
    private final ZPRandomization randomization;

    public ZPLootNbtRandomLong(long min, long max, @NotNull ZPRandomization randomization) {
        super(ZPLootNbtValue.TYPE_RANDOM_LONG);
        this.min = min;
        this.max = max;
    ...
    public void writeValue(@NotNull CompoundTag nbt, @NotNull String key) {
        nbt.putLong(key, this.randomization.random(this.min, this.max));
    }
