...
public class ZPLootNBTCompTagSerializer extends TypeAdapter<ZPLootNbtValue> {
    @Override
    public void write(JsonWriter out, ZPLootNbtValue value) throws IOException {
        JsonObject object = new JsonObject();
        final CompoundTag tag = ((ZPLootNbtCompoundTag) value).value();
        object.addProperty("type", TYPE_COMPOUNDTAG);
        object.addProperty("value", tag.toString());
