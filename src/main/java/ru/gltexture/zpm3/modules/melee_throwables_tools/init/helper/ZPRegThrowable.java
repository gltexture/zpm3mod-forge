...
import ru.gltexture.zpm3.modules.entity.instances.throwables.ZPPlateEntity;
import ru.gltexture.zpm3.modules.entity.instances.throwables.ZPRockEntity;
...
public abstract class ZPRegThrowable {
    public static void init(@NotNull ZPRegistry.ZPRegSupplier<Item> regSupplier) {
        ZPMeleeThrowableToolsItems.acid_bottle = regSupplier.register("acid_bottle",
        ...
        ZPMeleeThrowableToolsItems.plate = regSupplier.register("plate",
                () -> new ZPItemThrowable(((inaccuracy, velocity, itemstack, pLevel, pPlayer, pHand) -> {
        ...
        ZPMeleeThrowableToolsItems.rock = regSupplier.register("rock",
                () -> new ZPItemThrowable(((inaccuracy, velocity, itemstack, pLevel, pPlayer, pHand) -> {
