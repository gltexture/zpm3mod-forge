package ru.gltexture.zpm3.modules.melee_throwables_tools.tiers;
...
public enum ZPCommonToolMeleeTiers implements ZPTier {
    ...
    ZPCommonToolMeleeTiers(String id, int level, int uses, float speed, float damage, int enchant, TagKey<Block> tag, Supplier<Ingredient> repair, Object after, Object before) {
        this.id = id;
        this.level = level;
        this.uses = uses;
        this.speed = speed;
