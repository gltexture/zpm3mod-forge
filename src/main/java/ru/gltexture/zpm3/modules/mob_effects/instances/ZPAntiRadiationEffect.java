...
public class ZPAntiRadiationEffect extends ZPDefaultMobEffect {
    ...
    public void initializeClient(@NotNull Consumer<IClientMobEffectExtensions> consumer) {
        consumer.accept(new DefaultZPEffectClientExtension(true, ResourceLocation.fromNamespaceAndPath(ZombiePlague3.MOD_ID, "textures/mob_effects/radiation_protection.png")));
    }
}
